...
var searchWhole = new Vue({
    ...
    methods: {
        ...
        dislike:function(pid,title){
            //请求 0为删除喜欢,1为删除图片
            let postInfo = {pid:pid,uid:getUrlElement(this.thisUrl,'id'),request:0};
    ...
    created: function () {
        this.getPic(8, getUrlElement(this.thisUrl,'id'));
    }
});